...
app.controller("transectionsController", function ($rootScope, $scope, $location, $http, $filter, $timeout,$route, $routeParams,dbService) {
    ...
    vm.getData = function(pageno){ // This would fetch the data on page change.
        ...
        vm.list = [];
        $http.get($rootScope.local_api_url+"/transections/getList/"+vm.itemsPerPage+"/"+pageno+"/"+$rootScope.settings.sync_after_delete).success(function(response){
...
console.log(data2);
    ...
    $scope.addCart = function (detail) {
        ...
        function cartTotal(cart_subtotal) {
            ...
            $rootScope.cart_total = round_number( (parseFloat($scope.cart_subtotal) - parseFloat($rootScope.order_discount)) + parseFloat($rootScope.order_tax));
